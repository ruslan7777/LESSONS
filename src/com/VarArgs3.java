...
/*В этой программе продемонстрированы два способа перегрузки методов с переменнымчислом аргументов. Во-первых, перегруженные версии методов могут различаться
типом параметра, содержащего переменное количество аргументов. По этому принципуперегружены версии метода vaтest ( int ... ) и vaTest (boolean ... ) . Вспомните, что
многоточие говорит о том, что соответствующий аргумент должен рассматриваться как массив указанного типа. Поэтому, в полной аналогии с тем, как обычные методы можно
перегружать за счет использования различных типов параметра, соответствующего массиву,методы с переменным числом аргументов можно перегружать, используя различные
типы параметра varargs. На основании этого различия и будет определяться версия,подлежащая вызову.
